...
INSERT INTO STUDENT1 VALUES('4SF20CS089','AJAY','MANGALORE',987654067,'MALE');
INSERT INTO STUDENT1 VALUES('4SF20IS109','VARSHINI','BANTWAL',987611234,'FEMALE');
INSERT INTO STUDENT1 VALUES('4SF20CS098','NAVISH','UDUPI',8765406711,'MALE');
INSERT INTO STUDENT1 VALUES('4SF20CD001','SAHANA','SURATKA',9876544567,'FEMALE');
INSERT INTO STUDENT1 VALUES('4SF20CS088','KAVYA','MANGALORE',876514067,'FEMALE');
...
SELECT A.*,B.SEM,B.SECTION FROM STUDENT1 A, SEMSEC B, CLASS C 
WHERE  A.USN=C.USN AND B.SSID=C.SSID
AND B.SEM=4 AND B.SECTION ='C';

SELECT SEM,SECTION,GENDER,COUNT(*) FROM STUDENT1 S,SEMSEC SL,CLASS C 
WHERE S.USN =C.USN AND SL.SSID=C.SSID GROUP BY (GENDER,SEM,SECTION)ORDER BY (SEM);

CREATE VIEW TEST_MARKS AS SELECT SUBCODE,TESTI FROM IAMARKS WHERE USN='4SF21CD001';
 UPDATE IAMARKS SET finalia=GREATEST((testI+test2),(testI+test3),(test3+test2))/2;
